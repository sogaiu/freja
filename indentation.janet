(import freja/render_new_gap_buffer :as rngb)
...
(varfn delete-whitespace-backward!
  ...
  # delete whitespace
  (gb/delete-region! gb start end)
  # XXX: hack to cope with line number change
  #(when (not= curr-line-no
  #            (rngb/current-line-number gb))
  #  (goto-char gb (inc (gb :caret))))
  )
